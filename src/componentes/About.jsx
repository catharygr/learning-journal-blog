    ...
    <main>
      <div className="container-about">
        <div className="hero">
          <img
            className="foto-mia"
            src="./assets/image/cathy-retrato.jpg"
            alt=""
          />
          <div>
            <h1 className="titulo">
              Hi there! My name is Cathy and welcome to my learning journal.
            </h1>
            <p>
        ...
        <article>
          ...
          <p>
            ...
            session, I would use my notes to not only reflect on what I learned
